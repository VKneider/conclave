...
export default class ByTeamView extends HTMLElement {
  constructor(props) {
    super();
    slice.attachTemplate(this);
    this.$root = this.querySelector('.by-team-view');
    this.searchQuery = '';
  ...
  async _buildShell() {
    ...
    this.$searchInput = this.$root.querySelector('.sidebar-search');
  ...
  _layout() {
    ...
    teams.forEach((t) => {
      ...
      els.f.textContent = people.filter((p) => p.sexo === 'F').length;
...
customElements.define('slice-byteamview', ByTeamView);
